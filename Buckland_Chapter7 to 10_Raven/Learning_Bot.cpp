...
Learning_Bot::Learning_Bot(Raven_Game* world, Vector2D pos) : Raven_Bot(world, pos) {
	modeleAppris = world->getModeleApprentissage();

}

Learning_Bot::~Learning_Bot()
{
